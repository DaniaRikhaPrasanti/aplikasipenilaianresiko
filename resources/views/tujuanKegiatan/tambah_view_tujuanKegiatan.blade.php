                    ...
                    <div class="col-md-20 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Input Data Tujuan Kegiatan</h4>
                            </div>
                                            ...
                                            <div class="col-md-4">
					                            ...
					                            @if ($tujuan_skpd->ID_TUJUANSKPD === $sasaran[0]->ID_TUJUANSKPD)
                                                    <input type="text" id="URAIAN_TUJUANSKPD" class="form-control"
                                                        name="URAIAN_TUJUANSKPD" value="{{$tujuan_skpd->URAIAN_TUJUANSKPD}}" hidden>
                                                @endif
						                        @endforeach 
                                                </div>
					                            ...
					                            @if ($sasaran->ID_SASARAN === $nama_kegiatan[0]->ID_SASARAN)
                                                ...
                                                <div class="col-md-8 form-group">
                                                @foreach($nama_kegiatan as $nama_kegiatan)
					                            @if ($nama_kegiatan->ID_NAMAKEGIATAN === $nama_kegiatan->ID_NAMAKEGIATAN)
                                                    <textarea type="text" id="URAIAN_NAMAKEGIATAN" class="form-control"
                                                        name="URAIAN_NAMAKEGIATAN" rows="2" readonly>{{$nama_kegiatan->URAIAN_NAMAKEGIATAN}}</textarea>
                                                @endif
						                        @endforeach 
                                                </div>
                                                ...
                                                <div class="col-md-8 form-group">
                                                    <input type="text" id="ID_NAMAKEGIATAN" class="form-control"
                                                        name="ID_NAMAKEGIATAN" value="{{$nama_kegiatan->ID_NAMAKEGIATAN}}" hidden>
                                                </div>
                                                ...
                                                <div class="col-sm-12 d-flex justify-content-end">
                                                    ...
                                                    <a href='/tujuanKegiatan_view_tujuanKegiatan_{{ $nama_kegiatan->ID_NAMAKEGIATAN }}'>
