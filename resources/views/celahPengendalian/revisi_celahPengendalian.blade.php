                    ...
                    <div class="col-md-20 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Revisi Data Celah Pengendalian</h4>
                            </div>
                        <form action="/celahPengendalian_revisi_celahPengendalian" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="col-md-8 form-group">
                                                    <input type="text" id="PENGENDALIAN_YANG_ADA" class="form-control" class="bi bi-file-earmark-text" rows="4"
                                                        name="PENGENDALIAN_YANG_ADA" value="{{$daftar_resiko[0]->PENGENDALIAN_YANG_ADA}}"readonly>
                                                </div>
                                                ...
                                                <option value="{{ $ket->id_ket}}" readonly>{{ $ket->nama_ket}}</option>
                                                @endforeach
                                                </select>
                                                <br>
                                                </div>
                                                ...
                                                <div class="col-md-8 form-group">
                                                    <input type="text" id="YANG_MASIH_DIBUTUHKAN" class="form-control" class="bi bi-file-earmark-text" rows="4"
                                                        name="YANG_MASIH_DIBUTUHKAN" value="{{$daftar_resiko[0]->YANG_MASIH_DIBUTUHKAN}}"readonly>
                                                </div>
                                                ...
                                                <div class="col-md-8 form-group">
                                                    <input type="text" id="CATATAN3" class="form-control"
                                                        name="CATATAN3" value="{{$daftar_resiko[0]->CATATAN3}}">
                                                </div>
