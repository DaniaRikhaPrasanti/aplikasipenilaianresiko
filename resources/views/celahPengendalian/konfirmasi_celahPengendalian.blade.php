                    ...
                    <div class="col-md-20 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Konfirmasi Data Celah Pengendalian</h4>
                            </div>
                        <form action="/celahPengendalian_valid_celahPengendalian" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="col-sm-12 d-flex justify-content-end">
                                                    ...
                                                    <a href='/celahPengendalian_konfirmasi2_celahPengendalian_{{ $data->ID_DAFTARRESIKO }}'>
