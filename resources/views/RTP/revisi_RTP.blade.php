                    ...
                    <div class="col-md-20 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Revisi Data RTP</h4>
                            </div>
                        <form action="/RTP_revisi_RTP" method="post" enctype="multipart/form-data">
                                    ...
                                    <form class="form form-horizontal">
                                        <div class="form-body">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="col-md-8 form-group">
                                                    <input type="text" id="CATATAN4" class="form-control"
                                                        name="CATATAN4" value="{{$daftar_resiko[0]->CATATAN4}}">
                                                </div>
