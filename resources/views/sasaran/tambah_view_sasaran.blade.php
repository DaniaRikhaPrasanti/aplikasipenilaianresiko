                    ...
                    <div class="col-md-20 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Input Data Sasaran</h4>
                            </div>
                            <form action="/sasaran_tambah_view_sasaran" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="col-md-8 form-group">
                                                    <input type="text" id="ID_USER" class="form-control"
                                                        name="ID_USER" value="{{$daftar_tujuan_kegiatan[0]->ID_USER}}" hidden>
                                                </div>
                                               ...
                                               <div class="col-md-4">
					                            ...
					                            @if ($tujuan_skpd->ID_TUJUANSKPD === $tujuan_skpd->ID_TUJUANSKPD)
                                                ...
                                                <div class="col-md-8 form-group">
                                                    <textarea type="text" id="URAIAN_SASARAN" class="form-control"
                                                        name="URAIAN_SASARAN" placeholder="Sasaran SKPD"></textarea>
                                                </div>
                                                ...
                                                <div class="col-sm-12 d-flex justify-content-end">
                                                    ...
                                                    <a href='/sasaran_view_sasaran_{{ $tujuan_skpd->ID_TUJUANSKPD }}'>
