            ...
            <div class="page-content">
                <div class="row match-height">
                    <div class="col-md-20 col-12">
                        ...
                        <form action="/daftarKegiatan_update_daftarKegiatan" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8 form-group">
                                                    <input type="text" id="TAHUN_ANGGARAN" class="form-control"
                                                        name="TAHUN_ANGGARAN" value="{{ $daftar_tujuan_kegiatan[0]->TAHUN_ANGGARAN }}">
                                                </div>
                                                ...
                                                <div class="col-md-8 form-group">
                                                    <input type="text" id="CATATAN" class="form-control"
                                                        name="CATATAN" value="{{ $daftar_tujuan_kegiatan[0]->CATATAN }}">
                                                </div>
