                    ...
                    <div class="col-md-20 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Edit Data Analisis Resiko</h4>
                            </div>
                        <form action="/analisisResiko_update_analisisResiko" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="col-md-8 form-group">
                                                    <input type="text" id="SKOR_STATUS" class="form-control"
                                                        name="SKOR_STATUS" value="{{$daftar_resiko[0]->SKOR_STATUS}}">
                                                </div>
