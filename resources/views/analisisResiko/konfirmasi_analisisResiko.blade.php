                    ...
                    <div class="col-md-20 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Konfirmasi Data Analisis Resiko</h4>
                            </div>
                        <form action="/analisisResiko_valid_analisisResiko" method="post" enctype="multipart/form-data">
                                    ...
                                    <form class="form form-horizontal">
                                        <div class="form-body">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="col-md-8 form-group">
                                                <select class="form-control select2" name="ID_SKALA_KEMUNGKINAN" readonly>
                                                ...
                                                <div class="col-md-8 form-group">
                                                <select class="form-control select2" name="ID_SKALA_DAMPAK" readonly>
                                                ...
                                                <div class="col-sm-12 d-flex justify-content-end">
                                                    ...
                                                    <a href='/analisisResiko_konfirmasi2_analisisResiko_{{ $data->ID_DAFTARRESIKO }}'>
