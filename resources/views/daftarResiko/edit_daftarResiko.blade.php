                    ...
                    <div class="col-md-20 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Edit Data Daftar Resiko</h4>
                            </div>
                        <form action="/daftarResiko_update_daftarResiko" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="col-md-8 form-group">
                                                    <input type="text" id="PERNYATAAN_RESIKO" class="form-control"
                                                        name="PERNYATAAN_RESIKO" value="{{$daftar_resiko[0]->PERNYATAAN_RESIKO}}">
                                                </div>
                                                ...
                                                <div class="col-md-8 form-group">
                                                    <input type="text" id="DAMPAK_RESIKO" class="form-control"
                                                        name="DAMPAK_RESIKO" value="{{$daftar_resiko[0]->DAMPAK_RESIKO}}">
                                                </div>
